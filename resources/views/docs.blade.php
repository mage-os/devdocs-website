                                ...
                                <blockquote>
                                    <div class="mb-10 max-w-2xl mx-auto px-4 py-8 shadow-lg dark:bg-dark-600 lg:flex lg:items-center">
                                        <div class="w-20 h-20 mb-6 flex items-center justify-center shrink-0 bg-orange-600 lg:mb-0">
                                            <img src="{{ asset('/img/callouts/exclamation.min.svg') }}"
                                                 alt="Icon"
                                                 class="opacity-75"/>
                                        </div>
                                        ...
                                        <p class="mb-0 lg:ml-4">
                                            ...
                                            You're browsing the documentation for an old version of Mage-OS.
                                            Consider upgrading your project to
                                            <a href="{{ route('docs.version', DEFAULT_VERSION) }}">
                                                Mage-OS {{ DEFAULT_VERSION }}</a>.
                                        </p>
                                    </div>
                                </blockquote>
                            @endunless
                                ...
                                <blockquote>
                                    <div class="callout">
                                        <div class="mb-10 max-w-2xl mx-auto px-4 py-8 shadow-lg lg:flex lg:items-center">
                                            ...
                                            <p class="mb-0 lg:ml-4">
                                                <strong>WARNING</strong>
                                                You're browsing the documentation for an upcoming version of Mage-OS.
