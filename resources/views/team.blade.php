    ...
    <div class="relative overflow-hidden">
        <div class="relative max-w-screen-xl mx-auto px-5 pt-16 md:pt-32 space-y-8 md:space-y-0 md:flex md:items-end">
            <div class="md:flex-1">
                ...
                <p class="mt-3 max-w-xl text-gray-600 sm:mt-5 md:max-w-2xl md:mt-8 md:text-lg">Mage-OS wouldn’t be where it’s at today without people working on their free time to improve the product and gather resource around it. It takes a village to make it all happen and we want to recognize and thanks to the people and companies below who have contributed to the success and progression of Mage-OS.</p>
            </div>
        </div>
